...
import { Users, Search, Mail, Building2, Briefcase, X, Code } from 'lucide-react';

export default function EmployeesModal({ isOpen, onClose, employees = [] }) {
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '10px' }}>
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: '0.75rem', color: 'var(--accent-cyan)', fontWeight: 600 }}>{emp.title}</span>
                    </div>
                  </div>
                ...
                <div>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px' }}>
                    {emp.skills && emp.skills.length > 0 ? (
                      ...
                      <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', italic: true }}>No skills linked</span>
                    )}
                  </div>
                </div>
              </div>
